package com.gonguelun.javanikocalendar.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.gonguelun.javanikocalendar.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.gonguelun.javanikocalendar.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.gonguelun.javanikocalendar.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> processDataIntegrityViolationException(DataIntegrityViolationException ex, NativeWebRequest request) {
        Problem problem = Problem.builder().withStatus(Status.CONFLICT).with(MESSAGE_KEY, ErrorConstants.ERR_VALIDATION_DUPLICATE).build();
        return create(ex, problem, request);
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.gonguelun.javanikocalendar");
    }
}
